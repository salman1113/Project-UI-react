  ...
  return (
    <nav className="h-16 bg-[#001427]/90 backdrop-blur-md border-b border-[#708d81]/20 flex justify-between items-center px-6 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-4 md:gap-6">
        <button className="relative p-2 text-[#708d81] hover:text-[#f4d58d]">
          <FiBell className="text-xl" />
          <span className="absolute top-2 right-2 w-2 h-2 bg-[#bf0603] rounded-full border border-[#001427]"></span>
        </button>
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {showProfileMenu && (
            <div className="absolute right-0 mt-3 w-52 bg-[#001c3d] border border-[#708d81]/20 rounded-xl shadow-2xl py-2 z-50">
