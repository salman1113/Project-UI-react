...
const AdminProducts = () => {
  ...
  // ✅ Deleted IDs store cheyyanulla state
  ...
  // ✅ Helper: Object-il ninnu URL edukkaan
  ...
  const openModal = (product = null) => {
    if (product) {
      ...
      // ✅ Existing images with IDs load cheyyunnu
    ...
    setDeletedImageIds([]); // Reset deleted IDs
    setImageUrlInput("");
    setShowModal(true);
  };
  ...
  // ✅ Image Remove cheyyumbol ID store cheyyunnu
  ...
  const handleSubmit = async (e) => {
    ...
    // ✅ Deleted IDs Backend-ilekku ayakkunnu
